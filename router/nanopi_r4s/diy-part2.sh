...
git apply $GITHUB_WORKSPACE/router/nanopi_r4s/overclock.patch
cat $GITHUB_WORKSPACE/router/nanopi_r4s/kernel_mods.txt >> target/linux/rockchip/armv8/config-5.4
